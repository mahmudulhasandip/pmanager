                    ...
                    <div class="thumbnail" style="padding: 30px;">
                        <form method='post' action="{{ route('projects.update',[$project->id]) }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="description" name="description" placeholder="Project Description" rows="5" style="resize: vertical" required>{{ $project->description }}</textarea>
                            </div>
                    ...
                    <div class="thumbnail" style="padding: 30px;">
                        <div class="sidebar-module">
                            ...
                            <ol class="list-unstyled">
                                {{--  <li><a href="" >Back to company</a></li>  --}}
